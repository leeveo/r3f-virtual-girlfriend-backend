...
class Voices {
    ...
    search() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            var _a, _b;
            const { next_page_token: nextPageToken, page_size: pageSize, search, sort, sort_direction: sortDirection, voice_type: voiceType, category, fine_tuning_state: fineTuningState, include_total_count: includeTotalCount, } = request;
            const _queryParams = {};
    ...
    getShared() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            var _a, _b;
            const { page_size: pageSize, category, gender, age, accent, language, locale, search, use_cases: useCases, descriptives, featured, min_notice_period_days: minNoticePeriodDays, reader_app_enabled: readerAppEnabled, owner_id: ownerId, sort, page, } = request;
            const _queryParams = {};
            if (pageSize != null) {
                _queryParams["page_size"] = pageSize.toString();
            }
    ...
    getAProfilePage(handle, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.baseUrl))) !== null && _a !== void 0 ? _a : ((_b = (yield core.Supplier.get(this._options.environment))) !== null && _b !== void 0 ? _b : environments.ElevenLabsEnvironment.Production).base, `profile/${encodeURIComponent(handle)}`),
                method: "GET",
                headers: Object.assign({ "xi-api-key": (yield core.Supplier.get(this._options.apiKey)) != null
                        ? yield core.Supplier.get(this._options.apiKey)
                        : undefined, "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "elevenlabs", "X-Fern-SDK-Version": "1.56.0", "User-Agent": "elevenlabs/1.56.0", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version }, requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers),
